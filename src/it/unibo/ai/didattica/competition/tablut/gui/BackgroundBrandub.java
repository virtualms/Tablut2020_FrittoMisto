...
public class BackgroundBrandub extends Background{
	...
	public BackgroundBrandub()
	{
		...
		try
		{
			InputStream input = Gui.class.getResourceAsStream("it/unibo/ai/didattica/competition/tablut/resources/brandub1.png");
			super.background = ImageIO.read(input);
			super.background = super.background.getScaledInstance(283,292,Image.SCALE_DEFAULT);
			input = Gui.class.getResourceAsStream("it/unibo/ai/didattica/competition/tablut/resources/black3.png");
			super.black = ImageIO.read(input);
			super.black = super.black.getScaledInstance(34, 34, Image.SCALE_DEFAULT);
			input = Gui.class.getResourceAsStream("it/unibo/ai/didattica/competition/tablut/resources/White1.png");
			super.white = ImageIO.read(input);
			super.white = super.white.getScaledInstance(32, 32, Image.SCALE_DEFAULT);
			input = Gui.class.getResourceAsStream("it/unibo/ai/didattica/competition/tablut/resources/ImmagineRe.png");
